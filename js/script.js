$(document).ready(function () {
    ...
    $('#input_box').on("click ", function () {
        ...
        var str = this_val.substr(0, newPosn + 1);
        var html_calc = '<span>' + str + '</span>';
        $(".calwidth").html(html_calc);
        var width = $(".calwidth").find('span:first').width();
        if (str == "") {
            $(".carret").css("left", "15px");
        } else {
            $(".carret").css("left", width - 7);
        }
        console.log(width);
    });
